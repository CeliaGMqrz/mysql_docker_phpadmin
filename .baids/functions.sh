...
function mysql_docker_phpadmin.test-phpadmin-shell() {
...
function mysql_docker_phpadmin.test-mysql-shell() {
...
function mysql_docker_phpadmin.test-deploy() {
...
# Eliminar el entorno
function mysql_docker_phpadmin.test-down() {
...
function mysql_docker_phpadmin.test-get-mysql-ip() {
...
# Backup
function mysql_docker_phpadmin.test-mysql-dump-db() {
...
# Importación de db
function mysql_docker_phpadmin.test-mysql-import-db() {

  

  [ ! -n "$1" ] && echo -e "[!] sql dump not found \n
Usage: mysql_docker_phpadmin.test-mysql-import-db /path/to/dump.sql" && return
